        ...
        <div className="min-h-screen bg-black text-gray-300 font-sans py-20 px-6">
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <section className="space-y-4">
                    ...
                    <p>
                        The software, code, algorithms, and designs protected by the Licensr platform remain the sole intellectual property of their respective creators (the Licensor).
                ...
                <section className="space-y-4">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-400">
                        <li>Bypassing, removing, or disabling the Licensr protection module.</li>
                ...
                <section className="space-y-4">
                    ...
                    <p>
                        Licensr, acting on behalf of the Licensor, reserves the right to immediately and automatically revoke the license if "Code Tampering" is detected.
                        Upon revocation:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-gray-400">
                        ...
                        <li>The incident will be logged in the Licensr Global Blacklist.</li>
                    </ul>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <p>
                        ...
                        Licensr maintains forensic logs sufficient to support criminal and civil prosecution.
                    </p>
                </section>
